...
object SettingsStore {
    ...
    fun setWebTextZoom(textZoom: Int) =
        putSpValue(SP_SETTINGS, BaseApp.instance, KEY_WEB_TEXT_ZOOM, textZoom)

    fun getWebTextZoom() =
        getSpValue(SP_SETTINGS, BaseApp.instance, KEY_WEB_TEXT_ZOOM, DEFAULT_WEB_TEXT_ZOOM)

    fun setNightMode(nightMode: Boolean) =
        putSpValue(SP_SETTINGS, BaseApp.instance, KEY_NIGHT_MODE, nightMode)

    fun getNightMode() =
        getSpValue(SP_SETTINGS, BaseApp.instance, KEY_NIGHT_MODE, false)
}